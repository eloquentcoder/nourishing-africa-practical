...
export default function Login({ status }) {
    ...
    return (
        <Auth>
            <Head title="Log in" />
            <div className="flex flex-col items-center space-y-7 mt-16">
                <img src="/images/logo.png" alt="" className="" />
                <div className="text-center">
                    <h2 className="text-3xl font-bold">Welcome there!</h2>
                    <p className="text-2xs">Sign in to continue managing your user and company accounts</p>
                </div>
                ...
                <form onSubmit={submit} className="flex flex-col space-y-3 w-[400px]">
                    ...
                    <PrimaryButton text="Login" processing={processing} />
                </form>
                <div className="pt-10 text-sm">
                    <p>Don't Have An Account? Click <Link href="/register" className="text-blue-500">Here</Link> to register</p>
                </div>
            </div>
